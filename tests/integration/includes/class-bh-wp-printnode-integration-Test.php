<?php
/**
 * Tests for BH_WP_PrintNode main setup class. Tests the actions are correctly added.
 *
 ...
 * Class Develop_Test
 */
class BH_WP_PrintNode_Integration_Test extends \Codeception\TestCase\WPTestCase {
